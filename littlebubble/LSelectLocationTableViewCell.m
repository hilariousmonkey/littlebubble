//
//  LSelectLocationTableViewCell.m
//  littlebubble
//
//  Created by  罗海峰 on 2017/3/19.
//  Copyright © 2017年  罗海峰. All rights reserved.
//

#import "LSelectLocationTableViewCell.h"

@implementation LSelectLocationTableViewCell
...
-(void)initData:(NSDictionary*)initData{
    if (initData) {
        ...
        _cellTxt.text =  initData[@"cellTxt"];
    }
}
@end
